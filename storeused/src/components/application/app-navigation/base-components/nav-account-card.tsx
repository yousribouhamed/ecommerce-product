...
export const NavAccountMenu = ({
    ...
    return (
        <AriaDialog
            {...dialogProps}
            ref={dialogRef}
            className={cx("w-66 rounded-xl bg-background shadow-lg ring ring-border outline-hidden", className)}
        >
...
const NavAccountCardMenuItem = ({
    ...
    return (
        <button {...buttonProps} className={cx("group/item w-full cursor-pointer px-1.5 focus:outline-hidden", buttonProps.className)}>
            ...
            >
                <div className="flex gap-2 text-sm font-semibold text-foreground group-hover/item:text-foreground/80">
...
export const NavAccountCard = ({
    ...
    return (
        <div ref={triggerRef} className="relative flex items-center gap-3 rounded-xl p-3 ring-1 ring-border ring-inset bg-background">
            <AvatarLabelGroup
                size="md"
